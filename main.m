...
%% ========================================================================
%  Figure 5 (and Supplementary Figures 10..18): SINGLE SUBJECT ANALYSIS
% ========================================================================
% Task colors & legend
...
%% ========================================================================
%  Figure 6 – Boxplots: 3x3 subjects, each with 1x2 (Undesired | Preferred)
% ========================================================================
...
for subj = 1:9
    ...
    resultsTable{subj} = perform_anova_analysis(dataset, subj, 1); %This table contains the results of the statistical analysis for each subject
end
...
%% ========================================================================
%  Figure 7 – Histogram of Median Differences (CN − UCN)
% ========================================================================
...
%% ========================================================================
%  Figure 8 – Pre vs Post (MVF) boxplots aligned by subject
% ========================================================================
...
%% ========================================================================
%  Figure 19 – Boxplots: 3x3 subjects, each with 1x2 (Undesired | Preferred)
%  using only Fz
% ========================================================================
figure('Color','white', 'Units','inches', 'Position',[0.05 0.05 7 7],'Renderer', 'painters')
tOuter = tiledlayout(3,3, 'TileSpacing','loose', 'Padding','compact');
...
ylabel(tOuter, '$F$ [N]', 'Interpreter','latex', 'FontName','Times New Roman');
%% ========================================================================
%  Figure 20 – Boxplots: 3x3 subjects, each with 1x2 (Undesired |
...
function posthocTable = perform_anova_analysis(dataset, subj, flag)
